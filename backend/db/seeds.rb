...
authors.map do |author|
    Author.find_or_create_by(first_name: author[:first_name]) do |a|
        a.first_name = author[:first_name]
        a.last_name = author[:last_name]
        a.image = author[:image]
        a.birth_date = author[:birth_date]
        a.death_date = author[:death_date]
        a.wiki_page = author[:wiki_page]

        puts "author #{author[:first_name]} was created"
    end
end
...
books.map do |book|
    Book.find_or_create_by(title: book[:title]) do |b|
        ...
        puts "Book #{book[:title]} was created"
    end
end
